...
using Northwind.Business.Concrete.DependencyResolvers.Ninject;
...
namespace Northwind.WebFormsUI
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            _productService = InstanceFactory.GetInstance<IProductService>();                       //Burada son parantez içerisindeki NhProductDal değişince kullandığımız veritabanı da değişir.
